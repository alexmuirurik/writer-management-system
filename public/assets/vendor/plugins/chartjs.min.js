            ...
            return function t(e, n, i) {
                ...
                2: [
                    function (t, e, n) {
                        ...
                        function l(t, e) {
                            return "rgba(" + Math.round(t[0] / 255 * 100) + "%, " + Math.round(t[1] / 255 * 100) + "%, " + Math.round(t[2] / 255 * 100) + "%, " + (
                                e || t[3] || 1
                            ) + ")"
                        }
                        function s(t, e) {
                        ...
                        e.exports = {
                            ...
                            hsl2hsv: function (t) {
                                var e,
                                    ...
                                    a = t[1] / 100,
                                    o = t[2] / 100;
                                return 0 === o ? [0, 0, 0] : (o *= 2, a *= o <= 1 ? o : 2 - o, n =( o + a) / 2, e = 2 * a / (o + a), [
                                    i,
                                    100 * e,
                                    100 * n
                                ])
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    if (l.dataset._model.spanGaps && (u = u.filter(function (t) {
                                        ...
                                        for (e = 0, n = u.length; e < n; ++ e) 
                                            i = u[e]._model,
                                            a = o.splineCurve(o.previousItem(u, e)._model, i, o.nextItem(u, e)._model, l.dataset._model.tension),
                                    ...
                                    if (r.chart.options.elements.line.capBezierPoints) 
                                        for (e = 0, n = u.length; e < n; ++ e) 
                                            (i = u[e]._model).controlPointPreviousX = t(i.controlPointPreviousX, s.left, s.right),
                                            i.controlPointPreviousY = t(i.controlPointPreviousY, s.top, s.bottom),
                                            i.controlPointNextX = t(i.controlPointNextX, s.left, s.right),
                                            i.controlPointNextY = t(i.controlPointNextY, s.top, s.bottom)
                            ...
                            t.animationService = {
                                ...
                                advance: function (t) {
                                    for (var e, n, i = this.animations, a = 0; a < i.length;) 
                                        ...
                                        e.currentStep >= e.numSteps ? (o.callback(e.onAnimationComplete, [e], n), n.animating =! 1, i.splice(a, 1)) : ++ a
                        ...
                        e.exports = function (t) {
                            ...
                            a.extend(t.prototype, {
                                ...
                                render: function (e) {
                                    ...
                                    if (!1 !== s.notify(n, "beforeRender")) {
                                        ...
                                        if (r && (void 0 !== i && 0 !== i || void 0 === i && 0 !== r.duration)) {
                                            ...
                                            n.draw(),
                                            l(new t.Animation({numSteps: 0, chart: n}));
                                ...
                                handleEvent: function (t) {
                                    ...
                                    a.callback(n.onHover || n.hover.onHover, [
                                        t.native, e.active
                                    ], e),
                        ...
                        o.extend(r.prototype, {
                            ...
                            transition: function (t) {
                                ...
                                return n && 1 !== t ? (o || (o = e._view =
                                    {}), a || (a = e._start =
                                    {}), i(a, o, n, t), e) : (e._view = n, e._start = null, e)
                            },
                        ...
                        e.exports = function (t) {
                            ...
                            o.configMerge = function () {
                                return o.merge(o.clone(arguments[0]), [].slice.call(arguments, 1), {
                                    merger: function (e, n, i, a) {
                                        var r = n[e] || {},
                                            l = i[e];
                                        "scales" === e ? n[e] = o.scaleMerge(r, l) : "scale" === e ? n[e] = o.merge(r, [
                                    ...
                                    merger: function (e, n, i, a) {
                                        if ("xAxes" === e || "yAxes" === e) {
                                            ...
                                            for (n[e] || (n[e] =[]), r = 0; r < u; ++ r) 
                                                s = i[e][r],
                                                l = o.valueOrDefault(s.type, "xAxes" === e ? "category" : "linear"),
                                                r >= n[e].length && n[e].push({}),
                                                ! n[e][r].type || s.type && s.type !== n[e][r].type ? o.merge(n[e][r], [t.scaleService.getScaleDefaults(l), s]) : o.merge(n[e][r], s)
                            ...
                            o.splineCurveMonotone = function (t) {
                                ...
                                for (e = 0; e < l - 1; ++ e) 
                                    i = r[e],
                                    a = r[e + 1],
                                    i.model.skip || a.model.skip || (o.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = a.mK = 0 : (u = i.mK / i.deltaK, d = a.mK / i.deltaK, (h = Math.pow(u, 2) + Math.pow(d, 2)) <= 9 || (c = 3 / Math.sqrt(h), i.mK = u * c * i.deltaK, a.mK = d * c * i.deltaK)));
                    ...
                    e.exports = function (t) {
                        ...
                        t.Scale = r.extend({
                            ...
                            getRightValue: function (t) {
                                ...
                                return t
                        }, getLabelForIndex : l.noop, getPixelForValue : l.noop, getValueForPixel : l.noop, getPixelForTick : function (t) {
                            var e = this,
                                n = e.options.offset;
                            if (e.isHorizontal()) {
                            ...
                            if (i.display) {
                                ...
                                if (l.each(v, function (n, o) {
                                    ...
                                    if (p) 
                                        ...
                                        F = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top;
                                     else {
                ...
                e.exports = function (t) {
                    ...
                    t.Tooltip = a.extend({
                        ...
                        getCaretPosition: function (t, e, n) {
                            ...
                            if ("center" === h) 
                                l = g + v / 2,
                                "left" === c ? (a =( i = f) - u, o = i, r = l + u, s = l - u) : (a =( i = f + p) + u, o = i, r = l - u, s = l + u);
                ...
                e.exports = a.extend({
                    draw: function () {
                        ...
                        for (a._loop && d.length && d.push(d[0]), s.save(), s.lineCap = l.borderCapStyle || c.borderCapStyle, s.setLineDash && s.setLineDash(l.borderDash || c.borderDash), s.lineDashOffset = l.borderDashOffset || c.borderDashOffset, s.lineJoin = l.borderJoinStyle || c.borderJoinStyle, s.lineWidth = l.borderWidth || c.borderWidth, s.strokeStyle = l.borderColor || r.defaultColor, s.beginPath(), h = -1, t = 0; t < d.length; ++ t) 
                            ...
                            i = e._view,
                            0 === t ? i.skip || (s.moveTo(i.x, i.y), h = t) : (n = -1 === h ? n : d[h], i.skip || (h !== t - 1 && ! u || -1 === h ? s.moveTo(i.x, i.y) : o.canvas.lineTo(s, n._view, e._view), h = t));
                                ...
                                if (!(isNaN(n) || n <= 0)) {
                                    switch (e) {
                                        ...
                                        case "star": t.beginPath(),
                                            ...
                                            t.closePath();
                                            break;
                                        case "line": t.beginPath(),
                                            t.moveTo(i - n, a),
                                            t.lineTo(i + n, a),
                                            t.closePath();
                                            break;
                                        case "dash": t.beginPath(),
                                            t.moveTo(i, a),
                                            t.lineTo(i + n, a),
                                            t.closePath()
                                    }
            ...
            function (t, e, n) {
                ...
                var i = {
                    ...
                    clone: function (t) {
                        ...
                        if (i.isObject(t)) {
                            for (var e =
                                {}, n = Object.keys(t), a = n.length, o = 0; o < a; ++ o) 
                                e[n[o]] = i.clone(t[n[o]]);
            ...
            e.exports = function () {
                ...
                function u(t, e, n, i, a, o) {
                    ...
                    for (t.beginPath(), r = 0, u = p + !! o; r < u; ++ r) 
                        ...
                        f = l(c),
                        g = l(h),
                        f && g ? (x = m.push(c), y = b.push(h)) : x && y && (v ? (f && m.push(c), g && b.push(h)) : (s(t, m, b, x, y), x = y = 0, m =[], b =[]));
                ...
                return {
                    ...
                    afterDatasetsUpdate: function (i, o) {
                        ...
                        for (s = 0; s < c; ++ s) 
                            d = null,
                            (u =( l = i.getDatasetMeta(s)).dataset) && u._model && u instanceof a.Line && (d =
        ...
        e.exports = function (t) {
            var e = t.Scale.extend({
                    ...
                    switch (l.ticks.source) {
                        case "data": d = i._timestamps.data;
                            break;
                        case "labels": d = i._timestamps.labels;
                            break;
                        case "auto":
                        default: d = g(a, r, i.getLabelCapacity(a), l)
                    }
